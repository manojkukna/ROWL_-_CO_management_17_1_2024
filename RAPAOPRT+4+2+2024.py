...
def Price(df, Color, Clarity):
    ...
    # print(" Color", Color,row_index)
    # print("  Clarity",  Clarity,Price.columns.get_loc(Clarity))
    #
...
def raf_pidishan(df3):
    ...
    for index in index_raf_pidishan:
        ...
        # print(Price(df=RAPAOPRT_RED(CHANI="-2"), Color= raf_pidishan['Color'], Clarity=raf_pidishan[ 'Clarity']))
        # breakpoint()
        # raf_pidishan['Price'] = Price(df=RAPAOPRT_RED(CHANI="-2"), Color= raf_pidishan['Color'], Clarity=raf_pidishan[ 'Clarity'])*80
        ...
        # print(pd.DataFrame(raf_pidishan))
        # breakpoint()
